...
const ICONS = {
  ...
  subscription: "M17 1l4 4-4 4M3 11V9a4 4 0 0 1 4-4h14M7 23l-4-4 4-4M21 13v2a4 4 0 0 1-4 4H3",
  lend: "M4 2v20l2-1 2 1 2-1 2 1 2-1 2 1 2-1 2 1V2l-2 1-2-1-2 1-2-1-2 1-2-1zm3 5h10M7 12h10M7 15h5",
...
/* ---------------- useIsMobile (hook responsive) ---------------- */
/* Detecta viewport móvil vía matchMedia. Por defecto usa el breakpoint
   teléfono del contrato (640px); pasar 860 para el breakpoint del nav. */
...
Object.assign(window, {
  ...
  EmptyState, ToastProvider, useToast, ConfirmDialog, PageHeader, inputStyle, useIsMobile,
});
